...
local Window = Library.CreateLib("Hentai Hub", "DarkTheme")

--Player
local Player = Window:NewTab("Player")
local PlayerSection = Player:NewSection("Player")
PlayerSection:NewButton("Tp Tool", "ButtonInfo", function()
...
PlayerSection:NewButton("Invis", "ButtonInfo", function()
--[[Invisibility Toggle
...
local Keybind = "V" --Set to whatever you want, has to be the name of a KeyCode Enum.
...
PlayerSection:NewButton("Sturdy", "ButtonInfo", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/KATERGaming/Roblox/main/scripts/FE%20sturdy.lua"))()
end)
PlayerSection:NewButton("Inf Yield", "ButtonInfo", function()
